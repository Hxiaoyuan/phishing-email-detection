"""
This module contains utility functions that process the dataset extracted
...
def separate_features_target(dataframe, num_cols_ignore=2, class_col_name='email_class'):
    ...
    dataframe : pandas.DataFrame
        The DataFrame with dataset to split.
    num_cols_ignore : int
...
def impute_missing(train, test, strategy='mean'):
    ...
    dataset and will be used to transform the test dataset too.
